function check() { 
	...
	if(loanamt=="" || isNaN(parseFloat(loanamt)) || loanamt==0) { 
		...
		top.document.loan_form.amt.value="Please enter a valid loan amount.";
		...
		top.document.loan_form.pay.value="Please enter a valid loan amount.";
		top.document.loan_form.pay.focus();
		return false; 
	} else if(rate=="" || isNaN(parseFloat(rate)) || rate==0) {
		//alert("Please enter the interest rate.");
		top.document.loan_form.rate.value="Please enter the interest rate.";
...
function show() {
	...
	detail += "<table border='0' align='center' cellpadding='5' cellspacing='0' width='97%' style='font-family:courier;font-size:12px'> \
			<tr><td align='center' valign='bottom' ><b>Pmt</b></td><td align='right' valign='bottom' ><b>Amount</b></td> \
			<td align='right' valign='bottom' ><b>Interest</b></td><td align='right' valign='bottom' ><b>Principal</b></td> \
			<td align='right' valign='bottom' ><b>Balance</b></td></tr><tr><td align='center' >0</td> \
